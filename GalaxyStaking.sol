...
import "https://github.com/nebulae-js/GalaxyERC20/blob/main/GalaxyERC20.sol";
import "https://github.com/nebulae-js/GalaxyERC20/blob/main/GalaxyERC721.sol";
...
contract NFTStaking is Ownable, IERC721Receiver {
  ...
  Collection nft;
  galaxiesmostwanted token;

  // maps tokenId to stake
  mapping(uint256 => Stake) public vault; 

   constructor(Collection _nft, galaxiesmostwanted _token) { 
    nft = _nft;
    token = _token;
  }
